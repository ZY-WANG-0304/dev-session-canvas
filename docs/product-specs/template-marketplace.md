...
6. 点击"安装/更新"将最新版本下载到本地用户模板目录；安装按钮使用 split button，主按钮安装/更新最新版本，右侧下拉可选择安装某个历史版本
7. 如只想下载 JSON 文件，点击"下载" split button 主按钮下载最新版本，右侧下拉可下载特定历史版本
8. 安装完成后，模板出现在侧边栏模板列表中（标记为市场来源）
9. 浏览和下载无需登录
...
- [x] 可下载安装模板到本地（无需登录）
- [x] 插件内安装按钮采用 split button：主按钮安装/更新最新版本，下拉可安装特定版本
- [x] 插件内下载按钮采用 split button：主按钮下载最新版本，下拉可下载特定版本
- [x] 安装后模板出现在侧边栏，标记为市场来源
- [x] Web 端点击安装可唤起 VSCode
- [x] 预置官方种子模板
...
- [x] 插件内市场面板使用 VSCode 列表式紧凑密度，不使用三列大卡片墙、超大缩略图或大工具卡
- [x] 插件内安装 / 下载版本菜单在点击外部、搜索 / 排序变化或按 Escape 时关闭
...
- ✅ 市场 UI 主题口径：浏览器端浅色对应 `Light 2026`、深色对应 `Dark 2026`；插件内市场面板必须完整适配用户当前 VSCode Color Theme
