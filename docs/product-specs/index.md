...
| 文档 | 主题 | 状态 | 依据 | 最后更新 |
| --- | --- | --- | --- | --- |
| `docs/product-specs/agent-launch-modes-and-restart.md` | Agent 创建前启动方式、默认启动参数、停止后重启/新会话分流与 Codex / Claude Code Fork | 已确认 | `docs/PRODUCT_SENSE.md`、`ARCHITECTURE.md`、`docs/design-docs/agent-launch-modes-and-restart.md`、`docs/design-docs/execution-lifecycle-and-recovery.md` | 2026-07-04 |
