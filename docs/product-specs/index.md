...
| `docs/product-specs/canvas-node-groups.md` | 画布节点分组：把多个不同稳定节点组织到同一个可命名分组框中，并支持批量移动、恢复和模板保留 | 草案 | `docs/PRODUCT_SENSE.md`、`ARCHITECTURE.md`、`docs/design-docs/canvas-node-groups.md`、行业成熟画布分组方案调研 | 2026-05-21 |
