...
| `docs/product-specs/canvas-multi-root-workspace-support.md` | 当前画布对 VSCode multi-root workspace 的创建、执行、路径展示和会话历史支持 | 草案 | `docs/PRODUCT_SENSE.md`、`ARCHITECTURE.md`、`docs/design-docs/canvas-multi-root-workspace-support.md` | 2026-06-01 |
