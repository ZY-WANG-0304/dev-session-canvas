...
| `docs/product-specs/canvas-node-groups.md` | 画布节点分组：把多个不同稳定节点组织到同一个可命名分组框中，并支持批量移动、恢复、模板保留和空间导航 | 草案 | `docs/PRODUCT_SENSE.md`、`ARCHITECTURE.md`、`docs/design-docs/canvas-node-groups.md`、行业成熟画布分组方案调研 | 2026-06-06 |
| `docs/product-specs/canvas-multi-root-workspace-support.md` | 多根 workspace 组合视图：单根 root-local 画布、多根系统 root section 与空间导航 | 已确认 | `docs/PRODUCT_SENSE.md`、`ARCHITECTURE.md`、`docs/design-docs/canvas-multi-root-workspace-support.md`、`docs/exec-plans/active/canvas-multi-root-composed-canvas-rewrite.md`、`docs/exec-plans/completed/canvas-spatial-fit-minimap.md` | 2026-06-04 |
