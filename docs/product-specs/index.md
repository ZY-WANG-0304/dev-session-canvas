...
| `docs/product-specs/template-marketplace.md` | 模板市场：社区驱动的模板发现、发布、安装平台，含 Web 端、统计排名、版本管理与治理后台 | 草案 | `docs/PRODUCT_SENSE.md`、`ARCHITECTURE.md`、`docs/product-specs/canvas-template-feature.md`、`docs/design-docs/template-marketplace.md`、`docs/marketplace/UI.md` | 2026-06-07 |
