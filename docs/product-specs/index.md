...
| 文档 | 主题 | 状态 | 依据 | 最后更新 |
| --- | --- | --- | --- | --- |
| `docs/product-specs/explorer-resource-create-execution-node.md` | File Explorer 目录或普通文件右键创建绑定目标 cwd 的 Canvas Terminal / Agent 节点，以及多根 workspace 下普通创建入口 root 确认 | 草案 | `docs/PRODUCT_SENSE.md`、`ARCHITECTURE.md`、`docs/design-docs/explorer-resource-create-execution-node.md` | 2026-05-29 |
