...
- 阅读态中可直接勾选的任务列表、可点击外部链接与 workspace 文件链接、图片预览、代码高亮与数学公式
- 与其他对象的引用关系
- 可调整的窗口尺寸
- 更接近工作文档而不是设置表单的正文展示
...
- `Note` 节点阅读态中的 checklist 应可直接勾选并回写原始 Markdown；外部链接、workspace 内文件链接、图片、带语言标记的代码块和 `$` / `$$` 公式也应按各自语义展示，而不是退回成原始 Markdown 语法噪音。
