...
>
> `release-0-24-4-preparation` 已同步版本、CHANGELOG、Marketplace / README、发布手册和本设计记录。Node `25.6.0` / npm `11.8.0` 上已通过 manifest、发布 / workflow / VSIX 守卫、双扩展 typecheck、Runtime Supervisor protocol / Host backend / terminal journal / UI copy、重启恢复与两条 systemd reopen 真实 VS Code smoke、notifier source / companion / 英中 locale smoke、双 VSIX 打包、`0 vulnerabilities` production audit，以及 working-tree clean-checkout packaged-payload。候选 VSIX 只属于准备分支：主扩展为 `117` files / `3,933,884 bytes` / `sha256=2f42104db70c5f5ce9c23aefd2625c80ab3313cbbe222b5bd31a2cdeb004c1d8`，notifier 为 `14` files / `159,454 bytes` / `sha256=10104b203a36f38388291d76a5cf7fe55edae28e319d2b2dcf36557ccf960403`，dirty-tree README ref 为 `57eecf51c771990116b0f49913de27384d8d1731`。MR 合入后仍必须在 clean `main` ref 上重新完成双扩展打包、`publish/v0.24.4` dry-run、GitHub Release asset / Open VSX 验证和 VSM 状态记录。
