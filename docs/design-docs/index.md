...
| `docs/design-docs/public-marketplace-release-readiness.md` | 从当前内部 Preview VSIX 走向公开平台发布时的渠道选择、阻塞项分类与准备顺序 | VSCode 集成域、项目状态域 / 宿主集成层、适配与基础设施层 | 已选定 | 验证中 | `docs/exec-plans/completed/public-marketplace-release-readiness-research.md` | 2026-04-11 |
...
| `docs/design-docs/execution-lifecycle-and-recovery.md` | 执行节点的差异化生命周期、创建即打开规则，以及 Agent 自动恢复入口的正式边界 | VSCode 集成域、协作对象域、执行编排域、项目状态域 / 宿主集成层、画布呈现层、共享模型与编排层、适配与基础设施层 | 已选定 | 验证中 | `docs/product-specs/canvas-core-collaboration-mvp.md`、`docs/product-specs/runtime-persistence-modes.md`、`docs/exec-plans/active/agent-cli-launch-context-and-resume.md`、`docs/exec-plans/active/agent-running-state-detection.md`、`docs/exec-plans/completed/execution-lifecycle-recovery-and-autostart.md` | 2026-04-13 |
| `docs/design-docs/runtime-persistence-and-session-supervisor.md` | 将运行时持久化正式拆成 `snapshot-only` 与 `live-runtime` 两档，并为真实跨 VSCode 生命周期的进程存活引入会话监督器路线 | VSCode 集成域、协作对象域、执行编排域、项目状态域 / 宿主集成层、共享模型与编排层、适配与基础设施层 | 已选定 | 验证中 | `docs/product-specs/runtime-persistence-modes.md`、`docs/product-specs/canvas-core-collaboration-mvp.md`、`docs/exec-plans/completed/runtime-persistence-and-supervisor-design.md`、`docs/exec-plans/completed/remote-ssh-runtime-persistence-automation.md`、`docs/exec-plans/active/runtime-host-backend-systemd-user.md` | 2026-04-12 |
