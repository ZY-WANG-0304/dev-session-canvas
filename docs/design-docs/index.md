...
| `docs/design-docs/canvas-node-deletion.md` | 四类画布节点的删除入口、执行会话清理语义与删除后恢复边界 | 画布交互域、协作对象域、执行编排域、项目状态域 / 宿主集成层、画布呈现层、共享模型与编排层 | 已选定 | 验证中 | `docs/product-specs/canvas-core-collaboration-mvp.md`、`docs/exec-plans/active/canvas-node-deletion.md` | 2026-03-30 |
