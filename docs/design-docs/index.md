...
| `docs/design-docs/public-marketplace-release-readiness.md` | 公开 `Marketplace Preview` 的渠道选择、剩余 release-day 动作与发布边界判断 | VSCode 集成域、项目状态域 / 宿主集成层、适配与基础设施层 | 已选定 | 验证中 | `docs/exec-plans/completed/public-marketplace-release-readiness-research.md` | 2026-04-11 |
