...
| `docs/design-docs/canvas-file-activity-view.md` | provider 原生文件活动事件、文件节点与文件列表节点的正式边界 | 画布交互域、协作对象域、VSCode 集成域、执行编排域 / 宿主集成层、画布呈现层、共享模型与编排层、适配与基础设施层 | 已选定 | 已验证 | `docs/product-specs/canvas-core-collaboration-mvp.md`、`docs/product-specs/canvas-graph-links-and-file-activity.md`、`docs/exec-plans/active/canvas-graph-links-and-file-activity.md` | 2026-04-20 |
