...
| --- | --- | --- | --- | --- | --- | --- |
| `docs/design-docs/agent-launch-modes-and-restart.md` | Agent 创建前启动方式、默认启动参数、宿主 fresh-start 命令解析与停止后 split restart 的正式边界 | VSCode 集成域、画布交互域、协作对象域、执行编排域 / 宿主集成层、画布呈现层、共享模型与编排层 | 已选定 | 验证中 | `docs/product-specs/agent-launch-modes-and-restart.md`、`docs/exec-plans/active/agent-launch-modes-and-restart.md` | 2026-04-24 |
...
| `docs/design-docs/canvas-sidebar-node-and-session-lists.md` | 在现有 sidebar 容器里补齐当前画布节点列表与当前 workspace 会话历史列表，并定义节点定位与历史恢复的正式入口 | VSCode 集成域、画布交互域、协作对象域 / 宿主集成层、画布呈现层、共享模型与编排层、适配与基础设施层 | 已选定 | 验证中 | `docs/product-specs/canvas-sidebar-node-and-session-lists.md`、`docs/product-specs/canvas-sidebar-controls.md`、`docs/exec-plans/completed/canvas-sidebar-node-and-session-lists.md`、`docs/exec-plans/completed/canvas-sidebar-node-list-webview-conversion.md` | 2026-04-28 |
