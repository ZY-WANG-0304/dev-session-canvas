...
| --- | --- | --- | --- | --- | --- | --- |
| `docs/design-docs/marketplace-readme-media-automation.md` | `README.marketplace.md` 的截图与 GIF 如何基于真实 VS Code 宿主自动生成并稳定接入发布链路 | VSCode 集成域、画布交互域、项目状态域 / 宿主集成层、画布呈现层、适配与基础设施层 | 已选定 | 已验证 | `docs/exec-plans/completed/marketplace-real-vscode-media-automation.md` | 2026-04-16 |
