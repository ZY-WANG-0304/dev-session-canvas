...
当前进展入口见第6节，最新Linux原生U1切片见 `runtime-native-failure-isolation.md` 第24节：新6e96a9dc候选的U1-0一次/U1-4三次4/4，采集CLI与独立离线复核exit0；旧第20节3通过/1失败/2未运行及exit13、第21/22/23节各自4/4均保持，不合算。第30–43节保留此前原生、D1/D2及诊断工具历史；本次合成closing没有执行真实Push，不代表真实环境销毁、完整U1/W1或产品验收。
