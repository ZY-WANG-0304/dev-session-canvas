...
First you have to let VS Code know that you are contributing a view, using the [contributes.views](../references/contribution-points.md#contributes.views) Contribution Point in `package.json`.
...
- `getTreeItem(element: T): TreeItem | Thenable<TreeItem>` - Implement this to return the UI representation ([TreeItem](../references/vscode-api.md#TreeItem)) of the element that gets displayed in the view.
...
- `vscode.window.createTreeView` - Create the Tree View by providing the registered view ID and above data provider. This will give access to the [TreeView](../references/vscode-api.md#TreeView), which you can use for performing other view operations. Use `createTreeView`, if you need the `TreeView` API.
...
To contribute a View Container, you should first register it using [contributes.viewsContainers](../references/contribution-points.md#contributes.viewsContainers) Contribution Point in `package.json`.
...
Once you've created a View Container, you can use the [contributes.views](../references/contribution-points.md#contributes.views) Contribution Point in `package.json`.
...
You can control the visibility of these actions using a [when clause](../references/when-clause-contexts.md).
...
Extension writers should register a [TreeDataProvider](../references/vscode-api.md#TreeDataProvider) programmatically to populate data in the view.
