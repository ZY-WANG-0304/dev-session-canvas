...
If you are using the [Yeoman Generator](../get-started/your-first-extension.md) to scaffold an extension, integration tests are already created for you.
...
> 视频资源已在本地瘦身副本中移除：extension testing debug demo。
...
- [Continuous Integration](continuous-integration.md) - Run your extension tests in a Continuous Integration service such as Azure DevOps.
