...
[Menu items](../references/contribution-points.md#contributes.menus) appear in views, actions, and right-click menus. It's important that the grouping of menus remain consistent. If your extension has actions that relate to files, place your actions in the File Explorer context menu (when appropriate). If an extension has actions for certain file types, only display it for those items.
...
* [Context Menu API reference](../references/contribution-points.md#contributes.menus)
