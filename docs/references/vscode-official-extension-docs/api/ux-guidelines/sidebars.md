...
The Primary and Secondary Sidebars consists of one or more [Views](views.md) contributed by a [View Container](views.md#view-containers). Extensions can contribute Views to an existing View Container (for example, Explorer) or they can contribute an entirely new View Container.
...
- [Welcome View contribution point](../references/contribution-points.md#contributes.viewsWelcome)
