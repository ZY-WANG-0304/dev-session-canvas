...
The [Command Palette](../references/contribution-points.md#contributes.commands) is where all Commands are found. It's important that your command names are labeled appropriately so users can easily find them.
...
* [Commands API reference](../references/contribution-points.md#contributes.commands)
* [Commands extension guide](../extension-guides/command.md)
