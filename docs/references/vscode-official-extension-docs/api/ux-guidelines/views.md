...
When a view is empty, you can [add content to guide users](../references/contribution-points.md#contributes.viewsWelcome) on how to use your extension or get started. Links and icons are supported in Welcome views.
...
You can also [show progress in a view](../references/vscode-api.md#ProgressLocation) by referencing the view's ID.

![View with progress](images/examples/view-with-progress.png)

## View Actions

Views can expose [View Actions](../extension-guides/tree-view.md#view-actions) on the View Toolbar. Be careful not to add too many actions to avoid noise and confusion. Using the built-in product icons helps an extension fit in alongside the native UI. However, an SVG icon can be supplied if a custom icon is needed.

![Example of View Actions](images/examples/view-toolbar.png)

## Links

* [View Container API reference](../references/contribution-points.md#contributes.viewsContainers)
* [View API reference](../references/contribution-points.md#contributes.views)
