...
`activeWebviewPanelId` | The id of the currently active [webview panel](../extension-guides/webview.md).
`activeCustomEditorId` | The id of the currently active [custom editor](https://code.visualstudio.com/api/extension-guides/custom-editors).
...
You can have a when clause that checks if a specific [View](../ux-guidelines/views.md) is visible or focused.
...
You can have a when clause that checks if a specific [View Container](../ux-guidelines/views.md#view-containers) is visible
