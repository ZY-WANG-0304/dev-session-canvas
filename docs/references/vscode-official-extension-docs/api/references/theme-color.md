...
> 动画资源已在本地瘦身副本中移除：editorGroup.border。
- `editorGroup.dropBackground`: Background color when dragging editors around.
> 动画资源已在本地瘦身副本中移除：editorGroup.dropBackground。
