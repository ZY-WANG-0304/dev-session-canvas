...
**Contribution Points** are a set of JSON declarations that you make in the `contributes` field of the `package.json` [Extension Manifest](extension-manifest.md). Your extension registers **Contribution Points** to extend various functionalities within Visual Studio Code. Here is a list of all available **Contribution Points**:

- [`authentication`](contribution-points.md#contributes.authentication)
- [`breakpoints`](contribution-points.md#contributes.breakpoints)
- [`chatInstructions`](contribution-points.md#contributes.chatInstructions)
- [`chatPromptFiles`](contribution-points.md#contributes.chatPromptFiles)
- [`colors`](contribution-points.md#contributes.colors)
- [`commands`](contribution-points.md#contributes.commands)
- [`configuration`](contribution-points.md#contributes.configuration)
- [`configurationDefaults`](contribution-points.md#contributes.configurationDefaults)
- [`customEditors`](contribution-points.md#contributes.customEditors)
- [`debuggers`](contribution-points.md#contributes.debuggers)
- [`grammars`](contribution-points.md#contributes.grammars)
- [`icons`](contribution-points.md#contributes.icons)
- [`iconThemes`](contribution-points.md#contributes.iconThemes)
- [`jsonValidation`](contribution-points.md#contributes.jsonValidation)
- [`keybindings`](contribution-points.md#contributes.keybindings)
- [`languages`](contribution-points.md#contributes.languages)
- [`menus`](contribution-points.md#contributes.menus)
- [`problemMatchers`](contribution-points.md#contributes.problemMatchers)
- [`problemPatterns`](contribution-points.md#contributes.problemPatterns)
- [`productIconThemes`](contribution-points.md#contributes.productIconThemes)
- [`resourceLabelFormatters`](contribution-points.md#contributes.resourceLabelFormatters)
- [`semanticTokenModifiers`](contribution-points.md#contributes.semanticTokenModifiers)
- [`semanticTokenScopes`](contribution-points.md#contributes.semanticTokenScopes)
- [`semanticTokenTypes`](contribution-points.md#contributes.semanticTokenTypes)
- [`snippets`](contribution-points.md#contributes.snippets)
- [`submenus`](contribution-points.md#contributes.submenus)
- [`taskDefinitions`](contribution-points.md#contributes.taskDefinitions)
- [`terminal`](contribution-points.md#contributes.terminal)
- [`themes`](contribution-points.md#contributes.themes)
- [`typescriptServerPlugins`](contribution-points.md#contributes.typescriptServerPlugins)
- [`views`](contribution-points.md#contributes.views)
- [`viewsContainers`](contribution-points.md#contributes.viewsContainers)
- [`viewsWelcome`](contribution-points.md#contributes.viewsWelcome)
- [`walkthroughs`](contribution-points.md#contributes.walkthroughs)
...
| `when` | `string` | No | A [when clause](when-clause-contexts.md) condition that must be true for this entry to be enabled. |

See the [`chatPromptFiles`](contribution-points.md#contributes.chatPromptFiles) contribution point for contributing reusable prompt files.

## contributes.chatPromptFiles

Contributes [prompt files](https://code.visualstudio.com/docs/copilot/customization/custom-instructions.md) for Copilot Chat. Prompt files are reusable chat prompts that users can invoke as slash commands in chat. Use this contribution point to bundle ready-made prompts with your extension.
...
See the [`chatInstructions`](contribution-points.md#contributes.chatInstructions) contribution point for contributing reusable instructions files.
...
Color default values can be defined for light, dark and high contrast theme and can either be a reference to an existing color or a [Color Hex Value](theme-color.md#color-formats).
...
Contribute the UI for a command consisting of a title and (optionally) an icon, category, and enabled state. Enablement is expressed with [when clauses](when-clause-contexts.md). By default, commands show in the **Command Palette** (`kb(workbench.action.showCommands)`) but they can also show in other [menus](contribution-points.md#contributes.menus).
...
> **Note:** When using icons from [product icons](icons-in-labels.md#icon-listing), setting `light` and `dark` will disable the icon.
...
See the [Commands Extension Guide](../extension-guides/command.md) to learn more about using commands in VS Code extensions.
...
Contribute a new icon by ID, along with a default icon. The icon ID can then be used by the extension (or any other extensions that depend on the extension) anywhere a `ThemeIcon` can be used `new ThemeIcon("iconId")`, in [Markdown strings](icons-in-labels.md#icon-in-labels) (`$(iconId)`), and as icons in certain contribution points.
...
See the [File Icon Theme Guide](../extension-guides/file-icon-theme.md) on how to create a File Icon Theme.
...
Contribute a menu item for a command to the editor or Explorer. The menu item definition contains the command that should be invoked when selected and the condition under which the item should show. The latter is defined with the `when` clause, which uses the key bindings [when clause contexts](when-clause-contexts.md).
...
- `scm/repository` - [SCM repository menu](https://code.visualstudio.com/api/extension-guides/scm-provider#menus)
...
- `view/title` - [View title menu](contribution-points.md#contributes.views)
- `view/item/context` - [View item context menu](contribution-points.md#contributes.views)
- `webview/context` - any [webview](../extension-guides/webview.md) context menu
- Any [contributed submenu](contribution-points.md#contributes.submenus)
...
See the [Product Icon Theme Guide](../extension-guides/product-icon-theme.md) on how to create a Product Icon Theme.
...
See the [Color Theme Guide](../extension-guides/color-theme.md) on how to create a Color Theme.
