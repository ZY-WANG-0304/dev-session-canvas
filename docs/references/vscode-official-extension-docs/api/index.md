...
* Where to find [guides](extension-guides/overview.md) and [code samples](https://github.com/microsoft/vscode-extension-samples) to help get you started
* Following our [UX guidelines](ux-guidelines/overview.md) for best practices
...
* Change the look of VS Code with a color or file icon theme - [Theming](extension-capabilities/theming.md)
* Add custom components & views in the UI - [Extending the Workbench](extension-capabilities/extending-workbench.md)
* Create a Webview to display a custom webpage built with HTML/CSS/JS - [Webview Guide](extension-guides/webview.md)
...
If you'd like to have a more comprehensive overview of the Extension API, refer to the [Extension Capabilities Overview](extension-capabilities/overview.md) page. [Extension Guides Overview](extension-guides/overview.md) also includes a list of code samples and guides that illustrate various Extension API usage.
...
* **Testing and Publishing** includes in-depth guides on various extension development topics, such as [testing](working-with-extensions/testing-extension.md) and [publishing](working-with-extensions/publishing-extension.md) extensions.
* **Advanced Topics** explains advanced concepts such as [Extension Host](advanced-topics/extension-host.md), [Supporting Remote Development and GitHub Codespaces](advanced-topics/remote-extensions.md), and [Proposed API](https://code.visualstudio.com/api/advanced-topics/using-proposed-api).
* **References** contains exhaustive references for the [VS Code API](references/vscode-api.md), [Contribution Points](references/contribution-points.md), and many other topics.
