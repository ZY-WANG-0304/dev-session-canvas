...
We have a [Color Theme guide](../extension-guides/color-theme.md) and a [Color Theme sample](https://github.com/microsoft/vscode-extension-samples/tree/main/theme-sample) that illustrates how to create a theme.
...
The [File Icon Theme guide](../extension-guides/file-icon-theme.md) discusses how to create a File Icon Theme.
...
The [Product Icon Theme guide](../extension-guides/product-icon-theme.md) discusses how to create a Product Icon Theme.
