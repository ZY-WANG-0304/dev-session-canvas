...
> [!IMPORTANT]
> When you install extensions by using the [VS Code command line](https://code.visualstudio.com/docs/configure/command-line.md#working-with-extensions), the extension's publisher is not automatically trusted.
...
> [!TIP]
> If you want to enforce which extensions are allowed to be used in your organization, check out how to [configure allowed extensions in VS Code](https://code.visualstudio.com/docs/enterprise/extensions.md#configure-allowed-extensions).
...
* Learn how to install and manage extensions in [Visual Studio Code](extension-marketplace.md).

* Use [Workspace Trust](https://code.visualstudio.com/docs/editing/workspaces/workspace-trust.md) to decide whether code in a project folder can be executed by VS Code and extensions without explicit approval. This adds an extra layer of security when working with unfamiliar code.

* Configure [allowed extensions in VS Code](https://code.visualstudio.com/docs/enterprise/extensions.md#configure-allowed-extensions) to enforce which extensions are allowed to be used in your organization.
