...
- 当前 `0.16.1` 发布准备基线已 rebase 到 `70b6ff24e6e8e6bcc04d28dd5043d7873aa29e5f`，notifier manifest 与 changelog 已对齐到 `0.16.1`；本轮主扩展聚焦 multi-root root 水印可读性、执行终端恢复期间剪贴板诊断噪音收口，以及生产依赖 audit 告警收口，notifier companion 不引入新的通知投递行为变更。
