...
- 当前 `0.16.1` 发布准备基线为 `d947ee80cd3d1d0b47e6c6b91042060578f9668d`，notifier manifest 与 changelog 已对齐到 `0.16.1`；本轮主扩展聚焦 multi-root root 水印可读性与执行终端恢复期间剪贴板诊断噪音收口，notifier companion 不引入新的通知投递行为变更。
