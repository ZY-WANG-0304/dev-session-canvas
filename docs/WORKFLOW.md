...
3. 只有在 review 未发现新的确定性 blocker，且其他已知非阻塞问题已经从评论区沉淀到仓库文档、能被后续协作者直接追溯后，按 `docs/workflows/MR_MERGE.md` 给出可合并结论，等待用户确认。
4. 用户确认并许可后，reviewer 按 `docs/workflows/MR_MERGE.md` 执行合并。
