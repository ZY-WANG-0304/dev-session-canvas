...
interface NoteMarkdownMetadataEntry {
  key: string;
  value: string;
  title?: string;
}
...
const NOTE_MARKDOWN_FRONT_MATTER_DELIMITER_PATTERN = /^(?:---|\.\.\.)\s*$/u;
...
function parseNoteMarkdownFrontMatter(content: string): NoteMarkdownFrontMatter {
  ...
  while (cursor < source.length) {
    ...
    if (NOTE_MARKDOWN_FRONT_MATTER_DELIMITER_PATTERN.test(currentLine.text.trim())) {
